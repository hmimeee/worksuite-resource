...
<div class="row bg-title">
	...
	<div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right">
		<ol class="breadcrumb" style="display: inline-block !important;">
			<li style="font-size: 16px;"><a style="color:rgb(255, 47, 0);" href="{{ route('admin.resources.trash') }}"><i class="fa fa-trash"></i> Trash ({{ $trashCount }})</a></li>
		</ol>
	</div>
</div>
@endsection
            ...
            <div class="container">
                <div class="row it">
                    <div class="col-sm-offset-1 col-sm-10" id="one">
                        <form id="uploadDoc-form" action="{{ route('admin.resources.store') }}">
                            @csrf
                            <div id="uploader">
